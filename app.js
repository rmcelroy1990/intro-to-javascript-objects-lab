...
//game.party.push('Charmander', 'Pidgeotto', 'Pikachu')
//console.log(game.party);
...
//game.party.splice(0, 4, 'Ivysaur', 'Charmeleon', 'Pidgeot', 'Raichu');
//console.log(game.party);
...
//  for (let i = false; i < pokemon.length; i++) {
